...
class Config(object):
  ...
  AWS_SNS_JOB_REQUEST_TOPIC = \
    "some-arn-job-requests:rqiu_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = \
    "some-arn-job-results:rqiu_job_results"

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "rqiu_annotations"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "rqiu@mpcs-cc.com"
